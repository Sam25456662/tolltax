                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Axel</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Axel Edit</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('axe.update', $axe->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="card-body">
                                <div class="col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="axelno"
                                            placeholder="Enter Axel Number" value="{{ $axe->axelno }}" name="axelno" required>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="tax_rate"
                                            placeholder="Enter Tax Rate" value="{{ $axe->tax_rate }}" name="tax_rate" required>
